...
bipar2dBtn && (bipar2dBtn.onclick = function() {
  if(!bipar2dBox) return;
  bipar2dBox.style.display = 'block';
  biparInput.value = '';
  biparInput.focus();
});
biparInput && biparInput.addEventListener('keydown', function(e){
...
document.getElementById('lerQr').onclick = function() {
  document.getElementById('qr-show') && (document.getElementById('qr-show').style.display = 'block');
